package Tarefa_09.dao;

import Tarefa_09.utils.IgnoreInDAO;
...
/*
    ...
    2- A classe que herda do GenericDAO precisa ter um construtor vazio. ex: ProdutoDAO
    3- A Entity precisa ter um construtor vazio. ex: Produto
    ...
    5- Tabela precisa ter campo "id"
    6- Atributos da Entity precisa ter os mesmos campos da Tabela
        ex: Entity Produto: id, nome, quantidade, valorUnitario
            tabela: id (Primary Key, Auto Increment), nome, quantidade, valorUnitario 
*/
public abstract class GenericDAO<T> {
    ...
    // ex: AnimalDAO().getAll(Animal.class))
